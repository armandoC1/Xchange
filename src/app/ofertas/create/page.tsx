...
export default function CrearOferta() {
  ...
  useEffect(() => {
    const fetchCategorias = async () => {
      try {
        ...
        const res = await fetch('https://xchange-api-production.up.railway.app/categorias/list', { // aqui hay uno
          method: 'GET',
          headers: {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const res = await fetch('https://xchange-api-production.up.railway.app/ofertas/save', {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
        },
