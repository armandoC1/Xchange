...
export default function CrearSolicitud() {
    ...
    useEffect(() => {
        const fetchCategorias = async () => {
            try {
                ...
                const res = await fetch('http://3.137.192.224:8080/categorias/list', {
                    method: 'GET',
                    headers: {
    ...
    const enviarMensaje = async (contenido: string, idRemitente: number, idDestinatario: number) => {
        try {
            ...
            const res = await fetch('http://3.137.192.224:8080/mensajes/sendMenssage', {
                method: 'POST',
                headers: {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            const res = await fetch('http://3.137.192.224:8080/solicitudes/save', {
                method: 'POST',
                headers: {
                    Authorization: `Bearer ${token}`,
                },
